...
public class MainActivity extends AppCompatActivity {
        ...
        mCreateButton.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                if (mContentEditText.getText().toString().isEmpty()) {
                    mContentEditText.setError("Isi tulisannya dulu yaa");
  ...
  DialogInterface.OnClickListener okListener){
    ...
    private void createPdf() throws  FileNotFoundException, DocumentException {
        ...
        pdfFile = new File(docsFolder.getAbsoluteFile(), "PDFgenerate.pdf");
    ...
    private void previewPdf() {
        ...
        startActivity(intent);
            ...
            Toast.makeText(this, "Download aplikasi PDF viewer untuk melihat hasi generate", Toast.LENGTH_SHORT).show();
        }
    }
}